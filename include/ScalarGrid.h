#ifndef MYSCALRFIELD_H
#define MYSCALRFIELD_H
...
class ScalarGrid: public BaseGrid
{
public:
    ScalarGrid()
    {};
    ...
    inline int getFlatIndex(Size3 indices) const {
    ...
    void foreachIndex(std::function<void(int, int, int)> predicate) const;
    ...
    Vec3 dataCenterPosition(int i, int j, int k) const
    {
